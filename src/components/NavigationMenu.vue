...
export default {
  ...
  methods: {
    ...
    resetHomepage: function () {
      this.$http.delete("https://cv-database-2e255-default-rtdb.europe-west1.firebasedatabase.app/home-page.json")
    ...
    resetAboutPage: function () {
      this.$http.delete("https://cv-database-2e255-default-rtdb.europe-west1.firebasedatabase.app/about-page.json")
    ...
    resetEducation: function () {
      this.$http.delete("https://cv-database-2e255-default-rtdb.europe-west1.firebasedatabase.app/education.json")
      ...
      this.$http.post("https://cv-database-2e255-default-rtdb.europe-west1.firebasedatabase.app/education.json", {
        ...
        subjects: [{
          ...
          startDate: '2023-06-27',
          endDate: '2023-07-17',
          description: '240hour bootcamp, where I got basic web development knowledge. During training Java, PostgreSQL, RESTful API, Spring Boot, HTML5, CSS, CSS Bootsrap, JavaScript, Vue.js. technologies were used.',
    ...
    resetProjects: function () {
      this.$http.delete("https://cv-database-2e255-default-rtdb.europe-west1.firebasedatabase.app/projects.json")
